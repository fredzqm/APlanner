...
namespace APlanner.Database
{
    ...
    public partial class APlannerEntities : DbContext
    {
        ...
        public virtual int AddCourse(string courseDP, Nullable<short> courseNum, string courseName, string description, Nullable<byte> credit)
        {
            var courseDPParameter = courseDP != null ?
                new ObjectParameter("CourseDP", courseDP) :
                new ObjectParameter("CourseDP", typeof(string));
    
            var courseNumParameter = courseNum.HasValue ?
                new ObjectParameter("CourseNum", courseNum) :
                new ObjectParameter("CourseNum", typeof(short));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddCourse", courseDPParameter, courseNumParameter, courseNameParameter, descriptionParameter, creditParameter);
        }
        ...
        public virtual int AddSection(Nullable<int> termID, Nullable<short> courseID, Nullable<byte> sectNum, string pUserID, Nullable<byte> enrollNum, Nullable<int> capacity)
        {
            ...
            var sectNumParameter = sectNum.HasValue ?
                new ObjectParameter("SectNum", sectNum) :
                new ObjectParameter("SectNum", typeof(byte));
    
            var pUserIDParameter = pUserID != null ?
                new ObjectParameter("PUserID", pUserID) :
                new ObjectParameter("PUserID", typeof(string));
    
            var enrollNumParameter = enrollNum.HasValue ?
                new ObjectParameter("EnrollNum", enrollNum) :
                new ObjectParameter("EnrollNum", typeof(byte));
    
            var capacityParameter = capacity.HasValue ?
                new ObjectParameter("Capacity", capacity) :
                new ObjectParameter("Capacity", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddSection", termIDParameter, courseIDParameter, sectNumParameter, pUserIDParameter, enrollNumParameter, capacityParameter);
        }
        ...
        public virtual int CreateSection(Nullable<int> termID, string courseDP, Nullable<short> courseNum, Nullable<byte> sectNum, string pUserID, Nullable<int> capacity)
        {
            var termIDParameter = termID.HasValue ?
                new ObjectParameter("TermID", termID) :
                new ObjectParameter("TermID", typeof(int));
        ...
        public virtual int RemoveSection(string pUserID, Nullable<int> sectID)
        {
            var pUserIDParameter = pUserID != null ?
                new ObjectParameter("PUserID", pUserID) :
                new ObjectParameter("PUserID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RemoveSection", pUserIDParameter, sectIDParameter);
        }
        ...
        public virtual int WillNotOfferCourse(Nullable<int> termID, Nullable<short> courseID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WillNotOfferCourse", termIDParameter, courseIDParameter);
        }
    
        public virtual int WillOfferCourse(Nullable<int> termID, Nullable<short> courseID)
        {
            var termIDParameter = termID.HasValue ?
                new ObjectParameter("TermID", termID) :
                new ObjectParameter("TermID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WillOfferCourse", termIDParameter, courseIDParameter);
        }
    }
}
